...
const utilisateurs = require('../modeles/utilisateurs');
const Articles = require('../modeles/articles');
const Images = require('../modeles/images');
const Factures = require('../modeles/factures');
const Ajouters = require('../modeles/ajouter');
const Appartenir = require('../modeles/appartenir');
const Transferes = require('../modeles/transfere');
